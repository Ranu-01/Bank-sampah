...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Selamat Datang Di BANSTAL</h2>
        <ol class="breadcrumb">
                ...
                <div class="card bg-primary custom-card card-box">
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <img src="public/assets/img/pngs/logo_Banstal.png" alt="user-img">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-item">
                            ...
                            <div class="card-item-title mb-2">
                                <label class="main-content-label tx-13 font-weight-bold mb-1">Total
                                    Sampah</label>
                                <span class="d-block tx-12 mb-0 text-muted">Dalam Bulan ini</span>
                            </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <div class="card-item-title mb-2">
                                <label class="main-content-label tx-13 font-weight-bold mb-1">Akun Pengguna

                                </label>
                                <span class="d-block tx-12 mb-0 text-muted">Akun Dalam Bulan ini</span>
                            </div>
                            <div class="card-item-body">
                                <div class="card-item-stat">
                    ...
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <div class="card-item-title  mb-2">
                                <label class="main-content-label tx-13 font-weight-bold mb-1">Total
                                    Pemasukan </label>
                                <span class="d-block tx-12 mb-0 text-muted">Pemasukan Dalam Bulan ini</span>
                            </div>
                            <div class="card-item-body">
                                <div class="card-item-stat">
            ...
            <div class="col-sm-12 col-lg-12 col-xl-12">
                <div class="card custom-card overflow-hidden">
                    <div class="card-header border-bottom-0">
                        <div>
                            <label class="main-content-label mb-2">Project Budget</label> <span class="d-block tx-12 mb-0 text-muted">The Project Budget is a tool
                        ...
                        <div>
                            <div class="d-md-flex">
                                ...
                                <div class="ms-auto mt-3 d-flex">
                                    <div class="me-3 d-flex text-muted tx-13"><span class="legend bg-primary rounded-circle"></span>Project
                                    </div>
                                    <div class="d-flex text-muted tx-13"><span class="legend bg-light rounded-circle"></span>Inprogress
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="row mt-1">
                            ...
                            <div class="col-4 my-auto">
                                <div class="progress ht-6 my-auto">
                                    <div class="progress-bar ht-6 wd-80p" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-4 my-auto">
                                <div class="progress ht-6 my-auto">
                                    <div class="progress-bar ht-6 wd-70p" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-4 my-auto">
                                <div class="progress ht-6 my-auto">
                                    <div class="progress-bar ht-6 wd-40p" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                ...
                <div class="card custom-card mg-b-20">
                    <div class="card-body">
                        <div class="card-header border-bottom-0 pt-0 pe-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Tasks</label> <span class="d-block tx-12 mb-3 text-muted">A task is accomplished by
                        ...
                        <div class="table-responsive tasks">
                            <table class="table card-table table-vcenter text-nowrap mb-0  border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="font-weight-semibold d-flex"><label class="ckbox my-auto me-4"><input checked="" type="checkbox"><span></span></label><span class="mt-1">
                                    ...
                                    <tr>
                                        <td class="font-weight-semibold d-flex"><label class="ckbox my-auto me-4"><input type="checkbox"><span></span></label><span class="mt-1">Define
                                                the problem</span></td>
                                        <td class="text-nowrap">
                                            <div class="demo-avatar-group my-auto float-end">
                                                <div class="main-img-user avatar-sm">
            ...
            <table class="table table-hover m-b-0 transcations mt-2">
                <tbody>
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-inline-block">
                                <h6 class="mb-2 tx-15 font-weight-semibold">$45.234<i class="fas fa-level-up-alt ms-2 text-success m-l-10"></i>
                                </h6>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-inline-block">
                                <h6 class="mb-2 tx-15 font-weight-semibold">$23.452<i class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i>
                                </h6>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-inline-block">
                                <h6 class="mb-2 tx-15 font-weight-semibold">$78.001<i class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i>
                                </h6>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-inline-block">
                                <h6 class="mb-2 tx-15 font-weight-semibold">$37.285<i class="fas fa-level-up-alt ms-2 text-success m-l-10"></i>
                                </h6>
                                <p class="mb-0 tx-11 text-muted">4 Apr 2020</p>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-end pb-0">
                            <div class="d-inline-block">
                                <h6 class="mb-2 tx-15 font-weight-semibold">$25.341<i class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i>
                                </h6>
                                <p class="mb-0 tx-11 text-muted">4 Apr 2020</p>
                            </div>
                        </td>
