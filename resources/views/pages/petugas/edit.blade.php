        ...
        <div class="col-lg-8 col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="row row-sm">
                        <div class="col-md-12">
                            <form action="{{ route('petugas.update', ['id' => $data->user_id]) }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <p class="mg-b-10">Nama Petugas</p>
                                    <input type="text"
                                        class="form-control text-black @error('nama_petugas') is-invalid @enderror"
                                        name="nama_petugas" placeholder="Contoh: Supri" value="{{ $data->user->name }}">
                                    @error('nama_petugas')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="handphone" placeholder="Contoh: 08123456789" value="{{ $data->handphone }}">
                                    @error('handphone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Contoh: Jl. Doang Ga Jadian" value="{{ $data->alamat }}">
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                        ...
                                        placeholder="Contoh: rans@mail.com" value="{{ $data->user->email }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="password"
                                        ...
                                        name="password" placeholder="Contoh: ******">
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
