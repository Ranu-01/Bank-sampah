...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">RT</h2>
        </div>
        <div class="d-flex">
            <div class="justify-content-center">
                ...
                <a href="{{ route('rt.create') }}" class="btn btn-primary my-2 btn-icon-text">
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-body">
                    <div class="mb-3">
                        <h6 class="main-content-label mb-1">Data RT</h6>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($rt as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->rt }}</td>
                                        <td>{{ $data->rw->rw }}</td>
                                        <td><a href="{{ route('rt.edit', ['id' => $data->id]) }}"
                                                class="btn btn-info btn-icon-text my-2 mx-1"><i
                                                    class="fe fe-edit me-2"></i>Edit</a><a
                                                href="{{ route('rt.destroy', ['id' => $data->id]) }}"class="btn btn-danger btn-icon-text my-2 mx-1"><i
